...
public:
  ...
  double getMean(); //Gets the arithmetic mean of the items in the list.

  double getStdev(); //Gets the standard deviation of the list.

  AUList DuplicateNV(int N); //Returns an AUList with the first N values of the original AUList.
